...
import { Saveuser, DeleteMyUser } from './action/myaction';
                ...
                <div className='col-lg-12'>
                    ...
                    <p>
                        ...
                        <button 
                            ...
                            onClick={ ()=>dispatch( Saveuser() ) }> Save User 
                        </button>
                    </p>
                                ...
                                alluser.map((user, index)=>{
                                    return(
                                        <tr key={index}>
                                            ...
                                            <td> {user.edu} </td>
                                            <td> 
         <button className='btn btn-danger btn-sm' onClick={ ()=>dispatch(DeleteMyUser(index)) }> Delete </button>
                                            </td>
                                        </tr>
                                    )
                                })
